...
// Возвращаем информацию о детали
...
// Возвращаем информацию о деталях
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\fReleaseParts\x12!.inventory.v1.ReleasePartsRequest\x1a\".inventory.v1.ReleasePartsResponseB>Z<github.com/1mpuser/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
