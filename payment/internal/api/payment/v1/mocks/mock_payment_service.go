...
func (_mock *PaymentService) Pay(ctx context.Context, payRequest model.PayRequest) (string, error) {
	ret := _mock.Called(ctx, payRequest)
...
func (_e *PaymentService_Expecter) Pay(ctx interface{}, payRequest interface{}) *PaymentService_Pay_Call {
	return &PaymentService_Pay_Call{Call: _e.mock.On("Pay", ctx, payRequest)}
}

func (_c *PaymentService_Pay_Call) Run(run func(ctx context.Context, payRequest model.PayRequest)) *PaymentService_Pay_Call {
...
func (_c *PaymentService_Pay_Call) RunAndReturn(run func(ctx context.Context, payRequest model.PayRequest) (string, error)) *PaymentService_Pay_Call {
	_c.Call.Return(run)
	return _c
}
