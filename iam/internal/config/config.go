...
// MustLoad загружает конфигурацию или падает с паникой.
func MustLoad() {
...
// AppConfig возвращает загруженный конфиг (после MustLoad).
...
// ResolveConfigPath: флаг -config > env CONFIG_PATH > "config.local.yaml".
...
// Load читает YAML-файл, а поверх — env-переменные.
