...
import (
	...
	assemblyApp "github.com/1mpuser/assembly/pkg/app"
	iamApp "github.com/1mpuser/iam/pkg/app"
	invApp "github.com/1mpuser/inventory/pkg/app"
	inventoryClientPkg "github.com/1mpuser/order/internal/client/grpc/inventory/v1"
	...
	orderRepoPkg "github.com/1mpuser/order/internal/repository/order"
	"github.com/1mpuser/order/pkg/app"
	payApp "github.com/1mpuser/payment/pkg/app"
	wrappedKafkaConsumer "github.com/1mpuser/platform/pkg/kafka/consumer"
	wrappedKafkaProducer "github.com/1mpuser/platform/pkg/kafka/producer"
	kafkaMiddleware "github.com/1mpuser/platform/pkg/middleware/kafka"
