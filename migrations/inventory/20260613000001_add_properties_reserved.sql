...
ALTER TABLE
    parts
ADD
    COLUMN properties JSONB NOT NULL DEFAULT '{}',
ADD
    COLUMN reserved INT NOT NULL DEFAULT 0;
...
ADD
    CONSTRAINT chk_reserved_le_stock CHECK (reserved <= stock_quantity);
